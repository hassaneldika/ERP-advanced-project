...
const App = () => {
     ...
     * Loading & Projects
     */
    const [loadingEmployeeProjects, setLoadingEmployeeProjects] =
        useState(true);
    ...
    const getProject = async (slug) => {
        ...
        try {
            const response = await axios.get(`${url}api/projects/${slug}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
            const {
    ...
    const getEmployee = async (email) => {
        ...
        try {
            const response = await axios.get(`${url}api/employees/${email}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
            const {
    ...
    const getReport = async (email) => {
        ...
        try {
            const response = await axios.get(`${url}api/reports/${email}`, {
                headers: { Authorization: `Bearer ${token}` },
            });
            const {
    ...
    const getProjectsEmployee = async (email) => {
        ...
        try {
            const response = await axios.get(
                `${url}api/employees/${email}/projects`,
                {
                    headers: { Authorization: `Bearer ${token}` },
                }
            );
