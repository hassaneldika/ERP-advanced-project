  ...
  return (
    <div className="form-section category-form delete-category-form">
      <section className="heading">
        <h2>
          <AiFillDelete />{" "}
          {status ? "De/Activate Employee" : "De/Activate Employee"}
        </h2>
        <p>
          Are you sure you want to {status ? "De/activate" : "de/activate"}{" "}
        ...
        <form onSubmit={onSubmit}>
          <div className="form-group">
            <input
              ...
              value={status ? "De/Activate Employee" : "De/Activate Employee"}
            />
          </div>
        </form>
      </section>
